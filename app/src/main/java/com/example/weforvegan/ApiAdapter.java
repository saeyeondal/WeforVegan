...
public class ApiAdapter extends RecyclerView.Adapter<ApiAdapter.ViewHolder> implements OnMenuItemClickListener_api {
    ...
    private OnMenuItemClickListener_api mListener = null;

    public void setOnItemClickListener(OnMenuItemClickListener_api listener){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        return new ApiAdapter.ViewHolder(itemView);
    }
